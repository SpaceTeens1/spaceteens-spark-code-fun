...
const ContactSection = () => {
  ...
  return (
    <section id="contact" className="section-container bg-gradient-to-b from-spaceteens-blue/20 to-spaceteens-lightblue/5 relative overflow-hidden">
      {/* Space decorative elements */}
      <div className="absolute inset-0 w-full h-full">
        <div className="absolute top-20 right-20 w-20 h-20 rounded-full bg-gradient-to-br from-spaceteens-orange to-spaceteens-yellow opacity-10 blur-sm"></div>
        <div className="absolute bottom-40 left-20 w-32 h-32 rounded-full bg-gradient-to-br from-spaceteens-teal to-spaceteens-lightblue opacity-10 blur-sm"></div>
        <div className="absolute top-1/4 left-1/4 w-2 h-2 rounded-full bg-white shadow-lg shadow-white/50 animate-pulse-slow"></div>
        <div className="absolute bottom-1/4 right-1/4 w-1 h-1 rounded-full bg-white shadow-lg shadow-white/50 animate-pulse-slow"></div>
      </div>
      ...
      <div className="max-w-4xl mx-auto relative z-10">
        <div className="relative mb-8">
          ...
          <Sparkles className="absolute -top-10 right-1/4 text-spaceteens-teal h-6 w-6 animate-pulse-slow" />
        </div>
          ...
          <div className="bg-white/80 backdrop-blur-sm rounded-xl shadow-lg p-8">
            ...
            <div className="mt-10 grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="flex items-start space-x-4">
                <div className="bg-spaceteens-lightblue/30 p-3 rounded-full backdrop-blur-sm">
              ...
              <div className="flex items-start space-x-4">
                <div className="bg-spaceteens-yellow/40 p-3 rounded-full backdrop-blur-sm">
              ...
              <div className="flex items-start space-x-4 md:col-span-2">
                <div className="bg-spaceteens-teal/20 p-3 rounded-full backdrop-blur-sm">
      ...
      <div className="absolute bottom-1/4 left-1/3 h-px w-16 bg-gradient-to-r from-transparent via-white to-transparent transform -rotate-45 animate-pulse-slow" style={{animationDelay: '1.5s'}}></div>
    </section>
  );
};
